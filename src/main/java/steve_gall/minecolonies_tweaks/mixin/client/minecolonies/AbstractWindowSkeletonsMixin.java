...
@Mixin(value = {WindowBuildBuilding.class, WindowHireWorker.class, WindowHutAllInventory.class, WindowAssignCitizen.class, WindowResourceList.class, WindowClipBoard.class}, remap = false)
