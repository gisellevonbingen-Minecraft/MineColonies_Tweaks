...
public class LargeBottleCapabilityProvider implements ICapabilityProvider, IFluidHandlerItem
{
	private LazyOptional<IFluidHandlerItem> holder = LazyOptional.of(() -> this);
	...
	public FluidStack getFluid()
	{
		...
		else if (this.container.is(ModItems.large_milk_bottle) && ForgeMod.MILK.isPresent())
		{
	...
	{
		return resource.getFluid().isSame(Fluids.WATER) || (ForgeMod.MILK.isPresent() && resource.getFluid().isSame(ForgeMod.MILK.get()));
	}
	...
	public void setFluid(FluidStack resource)
	{
		...
		else if (ForgeMod.MILK.isPresent() && resource.getFluid().isSame(ForgeMod.MILK.get()))
		{
