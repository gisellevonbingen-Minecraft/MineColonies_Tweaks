...
{
	public static final ResourceLocation ICON_NULL = new ResourceLocation(Constants.MOD_ID, "textures/gui/modules/tweaks_null.png");
	...
	{
		super(MineColoniesTweaks.rl("gui/copyscroll_window.xml").toString(), null);
		...
		this.resourceList.setDataProvider(new DataProvider()
		{
			...
			public void updateElement(int index, Pane rowPane)
			{
				...
				{
					iconImage.setImage(ICON_NULL, false);
				}
	...
	public class ModuleCache
	{
		...
		{
			this.info = info;
			this.icon = new ResourceLocation(Constants.MOD_ID, "textures/gui/modules/" + info.icon() + ".png");
